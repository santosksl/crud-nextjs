    ...
    return (
        <div className="w-[100vw] h-[100vh] flex flex-col items-center mt-10 px-5 md:px-0">
            ...
            <p className="text-muted-foreground text-justify">
                We will finally create our products, you can list them soon
            </p>

            <div className="flex flex-col md:flex-row items-center justify-center gap-x-5 pt-10">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="300.47" height="239.54" viewBox="0 0 731.67 511.12">
                        ...
                        <polygon points="440.61 79.12 466.22 87.54 466.22 50.67 442.98 50.67 440.61 79.12" fill="#f8a8ab"/><circle cx="463.05" cy="35.35" r="25.52" fill="#f8a8ab"/>
                        ...
                        <form onSubmit={stateForm.handleSubmit(onSubmit)} method="POST" className="w-[300px] space-y-5">
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input {...field} placeholder="Smartphone X15 PRO"/>
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}/>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input {...field} placeholder="128GB, 16 RAM, Snapdragon E135s"/>
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}/>
                            ...
                            <div className="grid grid-cols-2 gap-x-5">
                                <div>
                                    <FormField control={stateForm.control} name="amount"
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>Amount</FormLabel>
                                            <FormControl>
                                                <Input {...field} type="number" placeholder="Value in stock"/>
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}/>
                                ...
                                <div>
                                    <FormField control={stateForm.control} name="price"
                                    render={({ field }) => (
                                            <FormItem>
                                ...
                                <div className="mt-3">
                                    <FormField control={stateForm.control} name="categoryId"
                                    render={({ field }) => (
                                            <FormItem>
                                ...
                                <div className="mt-3">
                                    <FormField control={stateForm.control} name="supplierId"
                                    render={({ field }) => (
                                            <FormItem>
